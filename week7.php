...
<section class="slide fade-6 kenBurns">
            ...
            <li class="col-5-12 cell-27">
              <div class="fix-4-12">
                <ul class="slider clickable ae-1 fromAbove" data-slider-id="27-2">
                  <li class="selected rounded-corners"><img src="" alt="More to come"/></li>
                  <li class="rounded-corners"><img src="" alt="More to come" /></li>
               ...
               <!-- link/blackqoute and form right for week7-->
            </li>
            <li class="col-7-12 left">
              <h1 class="ae-2 fromRight">Week 7 - Exploring solution & trying them on </h1>
              <div class="ae-3 fromRight">
                
              </div>
              <div class="relative">
                <div class="text-26">
                  <h3 class="ae-3 fromRight">...</h3>
                  <div class="ae-5 fromRight">
                    <p class="tiny opacity-6"><a href="">More to come</a></p>
                  </div>
                </div>
              </div>
            </li>
  ...
  <!-- background image  -->
  <div class="background" style="background-image:url(assets/img/background/pic01.jpg)"></div>
</section>
