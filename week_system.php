				...
				<div class="section__content section__content--p30">
					<h1 style="text-align: center;"><u>Week 0 (Before 8 Weeks)</u></h1>
						...
						<section class="card">
							...
							<p> Checkout all the details of the data of client required </p>
						 ...
						 <br>
						 <h1 style="text-align: center;"><u>Week 1</u></h1>
						<section class="card">
						 ...
						 <br>
						 <h1 style="text-align: center;"><u>Week 2</u></h1>
						 <section class="card">   
						 ...
						 <br>		
						 <h1 style="text-align: center;"><u>Week 3</u></h1>   
						 <section class="card">
						<h2> Money Matters</h2>
						 ...
						 <section class="card">
							...
							<div class="extra-info">    
							  <p>Deciding who gets what when a relationship ends can often be difficult and stressful for everyone. Attached is a link that will provide guidance and help for you with dividing your possesions in a way that will be fair for everyone.</p>
						 ...
						 <section class="card">
						  ...
						  <section class="card">
							...
							<a href="#" class="learn-more">Learn more</a>
							<div class="extra-info">    
							  <p>We have providing you with a parenting plan to help you and give you tips to think about and examples to assist you</p>
